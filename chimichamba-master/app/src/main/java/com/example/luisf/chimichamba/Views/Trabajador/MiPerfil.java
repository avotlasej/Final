...
public class MiPerfil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (trabajadorCRUD.hayTrabajador(idUsuarioFb)) {
            ...
            tvNombre.setText("Usuario: "+trabajador.getNombre());
            tvProfesion.setText("Profesió: "+trabajador.getProfesion());
            if(!trabajador.getCategoria().equals(""))
            tvCategoria.setText("Categoria: "+trabajador.getCategoria());
            tvAExperiencia.setText("Experiencia: "+String.valueOf(trabajador.getExperiencia()));
